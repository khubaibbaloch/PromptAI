...
import com.promptai.app.presentation.screens.savedPromptScreen.components.SavedPromptGrid
import com.promptai.app.presentation.screens.savedPromptScreen.components.SavedPromptSearchBar
import com.promptai.app.presentation.screens.savedPromptScreen.components.SavedPromptSectionHeader
import com.promptai.app.presentation.screens.savedPromptScreen.components.SavedPromptTopBar
...
fun SavedPromptScreen(navController: NavController) {
    ...
    LazyColumn(
        ...
        item {
            SavedPromptTopBar()
            SavedPromptSearchBar()
        }

        sections.forEach { sectionTitle ->
            item {
                SavedPromptSectionHeader(
